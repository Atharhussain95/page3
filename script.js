...
function page1() {
    ...
    // Add a delay before revealing elements
    gsap.delayedCall(0.5, revealTexts);
    gsap.delayedCall(0.5, revealImage);
}
...
function page2() {
    ...
    const staggerTextAnim = gsap.to(".stagger-text", {
        duration: 1,
        opacity: 1,
        y: 0,
        stagger: 0.3,
        ...
        scrollTrigger: {
            ...
            toggleActions: "play none none reverse",
            scrub: 1  // Add scrub for smooth scroll
        }
    });

    const linezerAnim = gsap.to(".linezer", {
        duration: 1,
        width: "90%",
        ease: "power2.inOut",
        scrollTrigger: {
